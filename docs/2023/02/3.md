...
> 本文编写于 2023/02/04 10:45 (CTS)

> 本文更新于 2023/02/04 10:45 (CTS)

[![](https://img.shields.io/badge/PyPi-msgs-success?style=flat-square)](https://pypi.org/project/msgs/)

## 使用方法
你可以运行 `pip install msgs` 以安装此程序
